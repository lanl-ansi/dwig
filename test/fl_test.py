...
class TestFLGeneration:
    ...
    def test_fl_i_1(self, capfd):
        json_comp(self.parser, capfd, 'fl_i_1.json', ['-cd', '2', '-tl', '-rs', '0', 'fl'])

    #../dwig.py -cd 2 -tl -rs 0 fl -s 4 -a 0.3 > data/fl_i_2.json
    def test_fl_i_2(self, capfd):
        json_comp(self.parser, capfd, 'fl_i_2.json', ['-cd', '2', '-tl', '-rs', '0', 'fl', '-s', '4', '-a', '0.3'])

    #../dwig.py -cd 2 -tl -rs 0 fl -mc -mll 0 > data/fl_i_3.json
    def test_fl_i_3(self, capfd):
        json_comp(self.parser, capfd, 'fl_i_3.json', ['-cd', '2', '-tl', '-rs', '0', 'fl', '-mc', '-mll', '0'])

    #../dwig.py -cd 12 -tl -rs 0 fl > data/fl_i_4.json
    def test_fl_i_4(self, capfd):
        json_comp(self.parser, capfd, 'fl_i_4.json', ['-cd', '12', '-tl', '-rs', '0', 'fl'])
