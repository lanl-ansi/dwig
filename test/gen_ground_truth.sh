...
../dwig.py -ic -pp -cd 12 -tl -rs 0 -os const -cp 0.2 -f -0.5 > data/const_i_4.json
...
../dwig.py -ic -pp -cd 12 -tl -rs 0 -os ran > data/ran1_i_3.json
...
../dwig.py -ic -pp -cd 12 -tl -rs 0 fl -sgs > data/fl_i_4.json
...
../dwig.py -ic -pp -cd 12 -tl -rs 1 fl -sgs -ccc > data/fcl_i_3.json
