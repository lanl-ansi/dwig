...
def build_cli_parser():
    ...
    parser_cbfm.add_argument('-j1-val', help='the value of the first coupling', type=float, default=-1.00)
    parser_cbfm.add_argument('-j1-pr',  help='the probability of the first coupling', type=float, default=0.625)
    parser_cbfm.add_argument('-j2-val', help='the value of the second coupling', type=float, default=0.20)
    parser_cbfm.add_argument('-j2-pr',  help='the probability of the second coupling', type=float, default=0.375)
    parser_cbfm.add_argument('-h1-val', help='the value of the first field', type=float, default=-1.00)
    parser_cbfm.add_argument('-h1-pr',  help='the probability of the first field', type=float, default=0.020)
    parser_cbfm.add_argument('-h2-val', help='the value of the second field', type=float, default=1.00)
    parser_cbfm.add_argument('-h2-pr',  help='the probability of the second field', type=float, default=0.010)
